...
print(f"Los casos totales a {fecha1.split(' ')} son: {cases_26feb} ")
...
print(f"Los casos totales a {fecha1.split(' ')} son: {cases_1jul} ")

# Obtener los 10 municipios con mayor cantidad de confirmados totales

rank = 10
worst_mun = funcovid.get_worst_muns(mun1jul,data)
print(worst_mun)
